$(function() {
    ...
    var owlbank = $('.owl-carousel.bankscroll');
    owlbank.owlCarousel({
        autoPlay: 5000,
        items: 5,
        itemsDesktop: false
    });
    var projectsCarousel = $("#latest-results .owl-carousel");
    ...
    $("#latest-results .custom-navigation .next").click(function() {
        projectsCarousel.trigger('owl.next');
    })
    $("#latest-results .custom-navigation .prev").click(function() {
    ...
    var clientsCarousel = $("#bank .owl-carousel");
    clientsCarousel.owlCarousel({
        items: 5,
        pagination: false
    });
    $("#bank .custom-navigation .next").click(function() {
        clientsCarousel.trigger('owl.next');
    })
    $("#bank .custom-navigation .prev").click(function() {
